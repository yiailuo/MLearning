...
class MNIST_MLP(object):
    ...
    def load_data(self):
        # TODO: 调用函数 load_mnist 读取和预处理 MNIST 中训练数据和测试数据的图像和标记,True为图像，False为标记
        ...
        print("train_images,train_labels,test_images,test_labels,self.train_data.shape,self.test_data.shape",
              train_images.shape, train_labels.shape, test_images.shape, test_labels.shape, self.train_data.shape,
