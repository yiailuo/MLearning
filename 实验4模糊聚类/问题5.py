...
def TransitiveClosure(a):
    ...
    平方法合成传递闭包
    """
    a = ArrageSimilarMatrix(a)  # 用模糊相似矩阵
    c = a
    while True:
        m = c
